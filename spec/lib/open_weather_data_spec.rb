  ...
  describe '#current_paris_weather' do
    context 'when returns a 401' do
      it 'returns the result as json' do
        ...
        allow_any_instance_of(OpenWeatherData).to receive(:get).and_return(unauthorized)
    ...
    context 'when returns ok' do
      it 'returns the result as json' do
        ...
        allow_any_instance_of(OpenWeatherData).to receive(:get).and_return(ok)
